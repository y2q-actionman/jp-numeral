...
(defun test-jp-formal-float ()
  ...
  (assert (equal "マイナス壱・壱分" (jp-str/f -1.1)))
  (assert (equal "マイナス壱・壱厘" (jp-str/f -1.01)))
  ;;
  t)
...
(defun test-jp-formal-parameters ()
  ...
  (assert (equal "弐分の壱a" (jp-str/f 1/2 :radix-point #\a)))
  (assert (equal "弐分の壱abc" (jp-str/f 1/2 :radix-point "abc")))
